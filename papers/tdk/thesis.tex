...
\newcommand{\vikcim}{Általános célú programnyelv szakterület-specifikus nyelvek megvalósítására} % Cím
...
\include{content/abstract}    %xTODO Összefoglaló -- TDK és OTDK esetén nem kötelező
