...
A használt \gls{DSL}-ek kódja azonos az előzőekben definiáltakkal, mind kettő megtalálható függelékben.
...
Ezzel párhuzamosan a futtatni szánt ``üzlet logikához'' tartozó kódot részekre lehet bontani, amelyet az ütemezőn keresztül lehet kényelmesen megvalósítani a függőségeket felhasználva.
...
\begin{figure}[htb]
    ...
    \end{subfigure}
    \caption{Példa a C4 nyelvben megvalósított \gls{eDSL}-ek együttes használatára}\label{fig:ex-mix}
\end{figure}
