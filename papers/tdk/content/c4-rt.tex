...
A direkt módon futtatható ,,szkript'' nyelvek többségének ez a típusozása, mert így a kód írása közben elég fejben tartani, hogy mi milyen típusú, nem kell kiírni mindenhova, hogy egy változó {\tt int} típusú.
Ilyenre példa a Perl, Tcl, Ruby és Python nyelvek.

A dinamikusan típusos nyelvek közös megvalósítási elemei, hogy rendelkeznek egy általában statikusan típusos nyelven (\pl C) megadott olyan adatszerkezettel, amelyik a dinamikus típust kezeli a futtatókörnyezet számára.
Ennek megvalósítására három verzióban elterjedt.
...
A struktúra egyéb mezői is részt vesznek az állapot meghatározásában, saját értékeik tárolása mellett.
Az előzőekhez hasonlóan a nem használt mezőt itt is régebbi verziók használták, és fenn van tartva a jövőbeli használatra.

Az előbb tárgyalt ``adatok'' mezőben négy elkülönülő adatot lehetséges kiolvasni, az állapottól függően.
