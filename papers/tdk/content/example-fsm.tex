...
\begin{figure}[hbt]
	\centerline{\includegraphics[width=.8\linewidth]{content/ex-stm.eps}}
...
Ezzel ennek az állapotgépnek, amelyik teljességében a {\tt myfsm} változóban található, a futtatása egy olyan léptető függvény definiálásával megvalósítható, hogy megadunk azt a függvényt, amelyik átveszi a jelenlegi állapotgép állapotot, lépteti egy bemenetnek megfelelően, majd visszaadja az új állapotot -- a közben szükséges akciókat végrehajtva.
