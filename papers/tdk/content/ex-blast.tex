...
Kiemelkedő probléma, hogy olyan szemi-strukturált adattároló formátumok, mint az egyes \gls{XML} dialektusok, és a \gls{HTML} sem kezelhető megfelelően általános módon reguláris kifejezésekkel még elméletileg sem; egyszerűen a nyelvek nemregularitása miatt.
...
Ebben rejlik egy nagy erőssége a már többször említett LISP nyelveknek, mert az általuk használt \gls{sexpr} szintaktika gyakorlatilag nem tartalmaz semmilyen olyan extra szintaktikát, ami a feldolgozáshoz nem direkt módon tartozik.
...
Még mielőtt az általam tervezett megoldást bemutatom megemlítendő, hogy egyes eszközök esetében lehetséges saját ellenőrzésekkel kibővíteni az ellenőrző eszközt.
