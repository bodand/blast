...
A problémára nagyszerűen illeszkedő programozási nyelv választásakor is előfordul azonban, hogy előkerülnek olyan részfeladatok, amelyekhez nincs szükség az előbb felsorolt programnyelvek teljes eszközkészletére, hogy megoldjuk ezeket.
...
Ez egy gyakran előforduló helyzet, hiszen sok esetben a nagy célprobléma részekre bontása során előállnak olyan részproblémák, amelyek megoldásához -- az előző paragrafusban tárgyalt \gls{GPL}-ek túlságosan gazdag lehetőségei miatt -- a nem annyira komplex és kevésbé általános nyelvi keretek könnyítenék a fejlesztést.
