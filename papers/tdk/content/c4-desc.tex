...
Ezek egy általános vázat adnak a végső nyelv viselkedésével kapcsolatban, és garantálják az elvárt módon való használhatóságát a nyelvnek.
...
Általánosan az immutábilis entitásokkal végzett programozás biztosít egy extra réteg védelmet a fejlesztői hibák ellen: fordítási időben az esetleges elírásokból eredő hibák elkerülhetőek, de futás közben az időbeli csatolásból eredő meglepő viselkedés elkerülésével is átláthatóbb lehet a kód.
...
Azonban ez sok programozó számára még idegenebb, mint a funkcionális felfogás, és így akár még kényelmetlen is tud lenni a Prolog jellegű kódolási stílus, ha az adott felhasználó nem rendelkezik megfelelő gyakorlattal.
...
Ez a rugalmasság LISP nyelvcsaládban \cite{mccarthyRecursiveFunctionsSymbolic1960} kiemelkedően jól látszik: a zárójeleket leszámítva, makrók felhasználásával a Scheme\footnote{egy LISP variáns} implementációkban akár teljesen új nyelvi elemeket lehet létrehozni \cite{freesoftwarefoundationinc.SyntaxRulesGuile2025}.
...
A C4 egyetlen kulcsszót tartalmaz: ez a {\tt let}, ezt csak a különböző nyelvi elemek definiálására szabad használni, és nem lehetséges felüldefiniálni mással.
...
Ha egy függvény definiálásánál értékként áll, akkor a nevesített függvény törzse, különben egy anonim függvény kifejezés (ezt lambdának is szokás hívni), amelyiknek értéke a blokkot tároló adat.
Ha a definiáláskor a befoglaló blokkban definiált vagy a megelőző globális függvények közül valamelyikre hivatkozik a blokk törzse, akkor egy lezárást (closure) definiál.
...
\paragraph{Függvény hívás} Egy függvényt a nevével, majd a megfelelő számú argumentum szóközökkel elválasztott megadásával lehet meghívni.
...
bar a        # 2 paraméter (bar/2): a, bar...
    bar b    # 2 paraméter (bar/2): b, foo1
        foo1
(bar a (bar b (foo)) # azonos, LISP-stílusú zárójelezéssel
\end{lstlisting}
...
A blokkot tároló objektumok kivételével, ez mindig nulla argumentumot jelent; a kiértékelés eredménye ilyenkor a meghívott érték.
