...
Ezt szokásos a projekthez tartozó {\tt Makefile}-ba írni, esetleg generáltatni, ha komplexebb lépésekre van szüksége a projekt fordítása előtt, mint például a célplatform képességeinek ellenőrzése.
...
Fontos megemlíteni, hogy ez a demó jellegű \gls{DSL} csak a feladatok ütemezését valósítja meg, a fájl írási időpontok alapú késznek tekintettséget nem.
