...
define ptr @c4_apply(ptr noundef %callee, i32 %n, ptr noundef %args, i64 %args_sz) {
    %ret = alloca %c4_completion_t, align 8                                     ; c4_completion_t ret

    store ptr @_c4_returner, ptr %ret, align 8                                  ; ret.self = @_c4_returner

    %ret.payload = getelementptr inbounds %c4_completion_t, ptr %ret, i32 0, i32 1
    ...
    %argv = call tailcc ptr @_c4_allocate_array(i64 %n_inc, i64 8)              ; argv = _c4_allocate_array(%n64 + 1, 8)
    ...
    call tailcc void @_c4_apply(ptr %argv, ptr %ret)
